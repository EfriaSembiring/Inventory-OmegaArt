        ...
        <tbody>
            <?php
                ...
                if (isset($_POST['bulan'])){
                    $bulan=$_POST['bulan'];
                    $tahun=$_POST['tahun'];
                    $sql="select * from barang_masuk m inner join detail_barang_masuk d on d.kode_transaksi=m.kode_transaksi where month(m.tanggal)='".$bulan."' and year(m.tanggal)='".$tahun."' group by m.kode_transaksi order by m.tanggal desc";
                }else {
                    $sql="select * from barang_masuk m inner join detail_barang_masuk d on d.kode_transaksi=m.kode_transaksi group by m.kode_transaksi order by m.tanggal desc";
                }
